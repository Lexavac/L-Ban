                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('up-status-user', ['user_id' => $user->id, 'status_code' => 0] ) }}" class="btn btn-danger">
                                             <i class="fa fa-ban"></i>
                                        </a>

                                    @else

                                        <a href="{{ route('up-status-user', ['user_id' => $user->id, 'status_code' => 1] ) }}" class="btn btn-success">
