            ...
            <div class="card-body">
              ...
              <form class="forms-sample" action="{{ route('store-user') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputName1" name="email" placeholder="Name">
                </div>

                <div class="form-group">
                  <label for="exampleInputName1">Password</label>
                  <input type="Password" class="form-control" id="exampleInputName1" name="password" placeholder="Name">
                </div>
