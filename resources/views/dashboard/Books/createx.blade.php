              ...
              <form class="forms-sample" action="{{ route('store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select name="publisher_id" class="form-control">
                    ...
                    <option value="{{ $id }}">{{ $publisherName }}</option>
                @endforeach
                </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" name="authors" placeholder="Author">
                  </div>

                <div class="form-group">
                    <label for="exampleInputName1">Publication Date</label>
                    <input type="date" class="form-control" id="exampleInputName1" name="publication_date" placeholder="Author">
                  </div>

                <div class="form-group">
                    <label for="exampleInputName1">Stock</label>
                    <input type="number" class="form-control" id="exampleInputName1" name="stock" placeholder="Stock">
                  </div>
