                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ $book->getMedia('trash')->first()->getUrl() }}" target="_blank">
                                        <img src="{{ $book->getMedia('trash')->first()->getUrl() }}" width="100px" height="50px" alt="">
                                    </a>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('trash-restore', $book->id) }}" class="btn btn-warning">
                                            <i class="fa fa-eye"></i>
                                        </a>

                                    <div class="btn-group">
                                        <a href="{{ route('trash-force', $book->id) }}" class="btn btn-info">
