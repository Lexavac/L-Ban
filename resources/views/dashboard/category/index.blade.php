                        ...
                        <table class="table table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach($category->books as $c)
                                        - {{ $c->name }} <br> <br>
                                    @endforeach
                                </td>
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('show', $category->id) }}" class="btn btn-warning">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <form onclick="return confirm('are you sure ?');" action="{{ route('destroy-category', $category->id) }}" method="post">
                                            @csrf
                                            @method('delete')
