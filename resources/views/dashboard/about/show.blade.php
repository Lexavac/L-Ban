                      ...
                      <div class="card-body">
                        ...
                        <table class="table table-hover">
                          <tbody>
                                ...
                                <tr>
                                    <th>Text 1</th>
                                     <td>{{ $about->imgtext1 }}</td>
                                </tr>

                                <tr>
                                    <th>Text 2</th>
                                    <td>{{ $about->imgtext2 }}</td>
                                </tr>

                                <tr>
                                    <th>Text 3</th>
                                    <td>{{ $about->imgtext3 }}</td>
                                </tr>
                                ...
                                <tr>
                                    <th>Image</th>
                                    <td>
                                        <a href="{{ $about->getMedia('about')->first()->getUrl() }}" target="_blank">
                                            <img src="{{ $about->getMedia('about')->first()->getUrl() }}" width="300px" height="200px" alt="">
                                        </a>
                                    </td>
                                </tr>
