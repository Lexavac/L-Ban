                        ...
                        <table class="table table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(count($book->gallery)  > 0)
                                    <a href="{{ $book->getMedia('gallery')->first()->getUrl() }}" target="_blank">
                                        <img src="{{ $book->getMedia('gallery')->first()->getUrl() }}" width="100px" height="50px" alt="">
                                    </a>
                                    @else
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('show-about', $book->id) }}" class="btn btn-warning">
                                            <i class="fa fa-eye"></i>
                                        </a>

                                    <div class="btn-group">
                                        <a href="{{ route('edit-about', $book->id) }}" class="btn btn-info">
                                             <i class="fa fa-pencil"></i>
                                        </a>


                                        <form onclick="return confirm('are you sure ?');" action="{{ route('destroy-about', $book->id) }}" method="post">
                                            @csrf
                                            @method('delete')
