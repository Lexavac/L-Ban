                        ...
                        <table class="table table-hover w-25">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $hero->sub }}</td>
                                <td>
                                    @if(count($hero->media)  > 0)
                                    <a href="{{ $hero->getMedia('media')->first()->getUrl() }}" target="_blank">
                                        <img src="{{ $hero->getMedia('media')->first()->getUrl() }}" width="100px" height="50px" alt="">
                                    </a>
                                    @else
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('edit-hero', $hero->id) }}" class="btn btn-info">
                                             <i class="fa fa-pencil"></i>
                                        </a>


                                        <form onclick="return confirm('are you sure ?');" action="{{ route('destroy-hero', $hero->id) }}" method="post">
                                            @csrf
                                            @method('delete')
