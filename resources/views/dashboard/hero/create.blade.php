        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" action="{{ route('store-hero') }}" method="POST">
                @csrf

                <div class="form-group">
                  <label for="exampleInputName1">Header</label>
                  <input type="text" class="form-control" id="exampleInputName1" name="header" placeholder=" Header Name">
                </div>

                <div class="form-group">
                  <label for="exampleInputName1">Sub Header</label>
                  <input type="text" class="form-control" id="exampleInputName1" name="sub" placeholder="Sub Header Name">
                </div>

                <div class="form-group">
                    <label for="exampleTextarea1">Description 1</label>
                    <textarea class="form-control" id="exampleTextarea1" placeholder="Description" name="desc1" rows="4"></textarea>
                  </div>

                <div class="form-group">
                    <label for="exampleTextarea1">Description 2</label>
                    <textarea class="form-control" id="exampleTextarea1"  placeholder="Description" name="desc2" rows="4"></textarea>
                  </div>
...
<script>
 ...
 @if(isset($hero) && $hero->media)
       var files =
         {!! json_encode($hero->media) !!}
           for (var i in files) {
           var file = files[i]
